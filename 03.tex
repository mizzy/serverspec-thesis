...
\centerline{\fbox{\box0}}
\caption{serverspecによりパッケージをテストをためのコード\label{fig:test-packages-with-serverspec}}
\end{figure}
...
\centerline{\fbox{\box0}}
\caption{serverspecによりサービスをテストするためのコード\label{fig:test-services-with-serverspec}}
\end{figure}
...
\centerline{\fbox{\box0}}
\caption{serverspecによりポートをテストするためのコード\label{fig:test-ports-with-serverspec}}
\end{figure}
